...
/* Define to 1 if you have the `Kernel_GetMemorySize' function. */
/* #undef HAVE_KERNEL_GETMEMORYSIZE */
...
/* Define to 1 if you have the <spi/kernel_interface.h> header file. */
/* #undef HAVE_SPI_KERNEL_INTERFACE_H */
