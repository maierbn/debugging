...
C      
       ...
       PARAMETER (MPI_BSEND_OVERHEAD=56)
       ...
       PARAMETER (MPI_LB=)
       INTEGER MPI_PACKED
       PARAMETER (MPI_PACKED=)
       INTEGER MPI_INTEGER1
       PARAMETER (MPI_INTEGER1=)
       INTEGER MPI_INTEGER2
       PARAMETER (MPI_INTEGER2=)
       INTEGER MPI_INTEGER4
       PARAMETER (MPI_INTEGER4=)
       INTEGER MPI_INTEGER8
       PARAMETER (MPI_INTEGER8=)
       INTEGER MPI_INTEGER16
       PARAMETER (MPI_INTEGER16=)
       INTEGER MPI_REAL4
       PARAMETER (MPI_REAL4=)
       INTEGER MPI_REAL8
       PARAMETER (MPI_REAL8=)
